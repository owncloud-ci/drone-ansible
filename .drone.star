    ...
    "steps": [
        {
            ...
            "commands": [
                "git fetch -tq",
                "git-chglog --no-color --no-emoji %s" % (ctx.build.ref.replace("refs/tags/v", "") or "--next-tag unreleased unreleased"),
                "git-chglog --no-color --no-emoji -o CHANGELOG.md %s" % (ctx.build.ref.replace("refs/tags/v", "") or "--next-tag unreleased unreleased"),
            ]
        },
        {
           "name": "release",
